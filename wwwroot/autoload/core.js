...
Components.Switch = class Switch extends Aventus.WebComponent {
    ...
    static __style = `:host{--internal-switch-background-color: var(--switch-background-color, var(--input-background-color, var(--primary-color, white)));--internal-switch-dot-size: var(--switch-dot-size, 20px);--internal-switch-dot-color: var(--switch-dot-color, var(--secondary-color));--internal-switch-active-dot-color: var(--switch-active-dot-color, var(--secondary-color-active));--internal-switch-active-background-color: var(--switch-active-background-color, var(--secondary-color))}:host{align-items:center;display:flex;font-size:var(--font-size-input);width:100%}:host .label:not(:empty){cursor:pointer;margin-right:30px;transition:filter .3s var(--bezier-curve)}:host .bar{align-items:center;background-color:var(--internal-switch-background-color);border-radius:10px;cursor:pointer;display:flex;height:10px;position:relative;transition:filter .3s var(--bezier-curve);width:30px}:host .bar input{appearance:none;background-color:rgba(0,0,0,0);border:0;cursor:pointer;height:100%;left:0;margin:0;outline:none;padding:0;position:absolute;top:0;width:100%}:host .bar .bar-content{align-items:center;background-color:rgba(0,0,0,0);display:flex;height:100%;pointer-events:none;position:relative;width:100%}:host .bar .bar-content .dot{background-color:var(--internal-switch-dot-color);border-radius:50%;box-shadow:none;cursor:pointer;height:var(--internal-switch-dot-size);left:0%;pointer-events:all;position:absolute;transform:translateX(-50%);transition:left var(--bezier-curve) .3s,box-shadow var(--bezier-curve) .3s,background-color var(--bezier-curve) .3s;width:var(--internal-switch-dot-size)}:host .bar .bar-content .bar-fill{background-color:var(--internal-switch-active-background-color);border-radius:100px;height:100%;left:0;pointer-events:all;position:absolute;top:0;transition:width var(--bezier-curve) .3s;width:0%}:host .bar input:checked+.bar-content .dot{background-color:var(--internal-switch-active-dot-color);box-shadow:0 0 5px var(--emphasize);left:100%}:host .bar input:checked+.bar-content .bar-fill{width:100%}:host([label_end]) .label:not(:empty){margin-left:30px;margin-right:0px;order:2}:host([disabled]) .bar{cursor:not-allowed;filter:brightness(0.75)}:host([disabled]) .bar input{cursor:not-allowed}:host([disabled]) .bar .bar-content .dot{cursor:not-allowed}:host([disabled]) .label{cursor:default;filter:brightness(0.75)}`;
    __getStatic() {
        return Switch;
    }
    __getStyle() {
...
Popup.Namespace=`${moduleName}`;
Popup.Tag=`rk-popup`;
_.Popup=Popup;
if(!window.customElements.get('rk-popup')){window.customElements.define('rk-popup', Popup);Aventus.WebComponentInstance.registerDefinition(Popup);}
...
const TestFrame2 = class TestFrame2 extends System.Frame {
    static __style = ``;
    __getStatic() {
        return TestFrame2;
    }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(TestFrame2.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<h1>salut</h1>` }
    });
}
    getClassName() {
        return "TestFrame2";
...
TestFrame2.Namespace=`${moduleName}`;
TestFrame2.Tag=`rk-test-frame-2`;
_.TestFrame2=TestFrame2;
if(!window.customElements.get('rk-test-frame-2')){window.customElements.define('rk-test-frame-2', TestFrame2);Aventus.WebComponentInstance.registerDefinition(TestFrame2);}
...
const ButtonIcon = class ButtonIcon extends Aventus.WebComponent {
  ...
  "content": {
    "buttonicon_0°src": {
      "fct": (c) => `${c.print(c.comp.__c3f2a3c0f315d83c4c34142e0b22930cmethod0())}`,
      "once": true
    }
  }
}); }
    ...
    __c3f2a3c0f315d83c4c34142e0b22930cmethod0() {
        return this.icon;
    }
}
ButtonIcon.Namespace=`${moduleName}`;
ButtonIcon.Tag=`rk-button-icon`;
_.ButtonIcon=ButtonIcon;
if(!window.customElements.get('rk-button-icon')){window.customElements.define('rk-button-icon', ButtonIcon);Aventus.WebComponentInstance.registerDefinition(ButtonIcon);}
...
const ContextMenuSeparator = class ContextMenuSeparator extends Aventus.WebComponent {
    priority = 0;
    menu;
    canBeRendered = () => true;
...
ContextMenuSeparator.Namespace=`${moduleName}`;
ContextMenuSeparator.Tag=`rk-context-menu-separator`;
_.ContextMenuSeparator=ContextMenuSeparator;
if(!window.customElements.get('rk-context-menu-separator')){window.customElements.define('rk-context-menu-separator', ContextMenuSeparator);Aventus.WebComponentInstance.registerDefinition(ContextMenuSeparator);}
...
Collapse.Tag=`rk-collapse`;
_.Collapse=Collapse;
if(!window.customElements.get('rk-collapse')){window.customElements.define('rk-collapse', Collapse);Aventus.WebComponentInstance.registerDefinition(Collapse);}

System.RayukiComponent = class RayukiComponent extends Aventus.WebComponent {
...
System.RayukiComponent.Namespace=`${moduleName}.System`;
_.System.RayukiComponent=System.RayukiComponent;

Components.Input = class Input extends System.RayukiComponent {
    static get observedAttributes() {return ["placeholder", "icon", "value"].concat(super.observedAttributes).filter((v, i, a) => a.indexOf(v) === i);}
  ...
  "content": {
    "input_3°@HTML": {
      "fct": (c) => `${c.print(c.comp.__7b4688f1d13a935f88db2286094e0088method3(c.data.error))}`,
      "once": true
    }
  }
    ...
    __7b4688f1d13a935f88db2286094e0088method3(error) {
        return error;
    }
}
...
System.Panel = class Panel extends System.RayukiComponent {
...
const ContextMenuItem = class ContextMenuItem extends Aventus.WebComponent {
    ...
    menu;
    canBeRendered = () => true;
    static __style = `:host{align-items:center;border-radius:5px;cursor:pointer;display:flex;font-size:var(--font-size-sm);margin:0 5px;padding:5px 10px}:host .title{margin-left:30px}:host .icon{display:none}:host([icon]) .title{margin-left:0px}:host([icon]) .icon{display:inline-block;margin-right:10px;width:20px}@media screen and (min-width: 1225px){:host{font-size:var(--font-size)}:host(:hover){background-color:var(--darker)}}`;
    ...
    __getHtml() {
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<rk-img class="icon" _id="contextmenuitem_0"></rk-img><div class="title" _id="contextmenuitem_1"></div>` }
    });
}
    __registerTemplateAction() { super.__registerTemplateAction();this.__getStatic().__template.setActions({
  "content": {
    "contextmenuitem_0°src": {
      "fct": (c) => `${c.print(c.comp.__b4269e70bf6c423758bb9c95c1a5b88cmethod0())}`,
      "once": true
    },
    "contextmenuitem_1°@HTML": {
      "fct": (c) => `${c.print(c.comp.__b4269e70bf6c423758bb9c95c1a5b88cmethod1())}`,
      "once": true
    }
  }
}); }
    ...
    __b4269e70bf6c423758bb9c95c1a5b88cmethod0() {
        return this.icon;
    }
    __b4269e70bf6c423758bb9c95c1a5b88cmethod1() {
        return this.text;
    }
}
ContextMenuItem.Namespace=`${moduleName}`;
ContextMenuItem.Tag=`rk-context-menu-item`;
_.ContextMenuItem=ContextMenuItem;
if(!window.customElements.get('rk-context-menu-item')){window.customElements.define('rk-context-menu-item', ContextMenuItem);Aventus.WebComponentInstance.registerDefinition(ContextMenuItem);}
...
const Confirm = class Confirm extends Popup {
  ...
  "content": {
    "confirm_0°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4efc5c4e539a6785e6fbc75b5c57018amethod0())}`,
      "once": true
    },
    "confirm_1°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4efc5c4e539a6785e6fbc75b5c57018amethod1())}`,
      "once": true
    },
    "confirm_2°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4efc5c4e539a6785e6fbc75b5c57018amethod2())}`,
      "once": true
    },
    "confirm_3°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4efc5c4e539a6785e6fbc75b5c57018amethod3())}`,
      "once": true
    }
  },
  "pressEvents": [
    ...
    __4efc5c4e539a6785e6fbc75b5c57018amethod0() {
        return this.subject;
    }
    __4efc5c4e539a6785e6fbc75b5c57018amethod1() {
        return this.body;
    }
    __4efc5c4e539a6785e6fbc75b5c57018amethod2() {
        return this.btn_no_txt;
    }
    __4efc5c4e539a6785e6fbc75b5c57018amethod3() {
        return this.btn_yes_txt;
    }
}
Confirm.Namespace=`${moduleName}`;
Confirm.Tag=`rk-confirm`;
_.Confirm=Confirm;
if(!window.customElements.get('rk-confirm')){window.customElements.define('rk-confirm', Confirm);Aventus.WebComponentInstance.registerDefinition(Confirm);}

const ContextMenu = class ContextMenu extends Aventus.WebComponent {
    static instance;
    _items = [];
    isTouch = false;
  ...
  "elements": [
    ...
    caluclatePosition(pageX, pageY, element) {
...
ContextMenu.Namespace=`${moduleName}`;
ContextMenu.Tag=`rk-context-menu`;
_.ContextMenu=ContextMenu;
if(!window.customElements.get('rk-context-menu')){window.customElements.define('rk-context-menu', ContextMenu);Aventus.WebComponentInstance.registerDefinition(ContextMenu);}
...
Data.Desktop.$schema={"Name":"string","Background":"string","UserId":"number","Icons":"DesktopAppIcon","Applications":""+moduleName+".Data.ApplicationOpen"};Aventus.DataManager.register(Data.Desktop.Fullname, Data.Desktop);Data.Desktop.Namespace=`${moduleName}.Data`;Aventus.Converter.register(Data.Desktop.Fullname, Data.Desktop);
...
_.CoreHttpRoutes=CoreHttpRoutes;
const CoreRouter=class CoreRouter extends Aventus.HttpRouter.WithRoute(CoreHttpRoutes) {
    defineOptions(options) {
        options.url = location.protocol + "//" + location.host + "";
        return options;
    }
}
CoreRouter.Namespace=`${moduleName}`;
_.CoreRouter=CoreRouter;
...
const ApplicationHistoryConvert=class ApplicationHistoryConvert extends Aventus.ConverterTransform {
    manager;
    constructor(manager) {
        super();
...
ApplicationHistoryConvert.Namespace=`${moduleName}`;
_.ApplicationHistoryConvert=ApplicationHistoryConvert;
...
const Alert = class Alert extends Popup {
  ...
  "content": {
    "alert_0°@HTML": {
      "fct": (c) => `${c.print(c.comp.__a40464656c33230d84d7f25cd99d861cmethod0())}`,
      "once": true
    },
    "alert_1°@HTML": {
      "fct": (c) => `\r\n    ${c.print(c.comp.__a40464656c33230d84d7f25cd99d861cmethod1())}\r\n`,
      "once": true
    },
    "alert_2°@HTML": {
      "fct": (c) => `${c.print(c.comp.__a40464656c33230d84d7f25cd99d861cmethod2())}`,
      "once": true
    }
  },
  "events": [
    ...
    __a40464656c33230d84d7f25cd99d861cmethod0() {
        return this.subject;
    }
    __a40464656c33230d84d7f25cd99d861cmethod1() {
        return this.body;
    }
    __a40464656c33230d84d7f25cd99d861cmethod2() {
        return this.btn_txt;
    }
}
Alert.Namespace=`${moduleName}`;
Alert.Tag=`rk-alert`;
_.Alert=Alert;
if(!window.customElements.get('rk-alert')){window.customElements.define('rk-alert', Alert);Aventus.WebComponentInstance.registerDefinition(Alert);}

System.Application = class Application extends System.RayukiComponent {
...
System.HomeBtn = class HomeBtn extends System.RayukiComponent {
...
System.BottomBar = class BottomBar extends System.RayukiComponent {
    get desktop() {
...
const AppIconManager=class AppIconManager {
    static loaded = [];
    static dico = {};
    static tags = {};
    static waiting = [];
...
AppIconManager.Namespace=`${moduleName}`;
_.AppIconManager=AppIconManager;
...
System.AppIcon = class AppIcon extends System.RayukiComponent {
...
const TableTest = class TableTest extends Components.Table {
    static __style = ``;
    __getStatic() {
        return TableTest;
    }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(TableTest.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
...
TableTest.Namespace=`${moduleName}`;
TableTest.Tag=`rk-table-test`;
_.TableTest=TableTest;
if(!window.customElements.get('rk-table-test')){window.customElements.define('rk-table-test', TableTest);Aventus.WebComponentInstance.registerDefinition(TableTest);}

const TestFrame = class TestFrame extends System.Frame {
    static __style = `:host{padding:30px}`;
    __getStatic() {
        return TestFrame;
    }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(TestFrame.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<rk-table-test col_resize></rk-table-test>` }
    });
}
    getClassName() {
        return "TestFrame";
...
TestFrame.Namespace=`${moduleName}`;
TestFrame.Tag=`rk-test-frame`;
_.TestFrame=TestFrame;
if(!window.customElements.get('rk-test-frame')){window.customElements.define('rk-test-frame', TestFrame);Aventus.WebComponentInstance.registerDefinition(TestFrame);}

System.TestApplication = class TestApplication extends System.ApplicationSidnav {
    static __style = ``;
    __getStatic() {
    ...
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(TestApplication.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
...
System.TestApplication.Namespace=`${moduleName}.System`;
System.TestApplication.Tag=`rk-test-application`;
_.System.TestApplication=System.TestApplication;
if(!window.customElements.get('rk-test-application')){window.customElements.define('rk-test-application', System.TestApplication);Aventus.WebComponentInstance.registerDefinition(System.TestApplication);}
